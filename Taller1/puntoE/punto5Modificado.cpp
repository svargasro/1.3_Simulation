...
int main(){
  ...
  int numOrbitas = 1; //Número total de órbitas.
  ...
  for(t=0;t<ttotal;t+=dt){
    ...
    fout<<x_s<<" "<<y_s<<" "<<x_j<<" "<<y_j<<" "<<" "<<x_t<<" "<<y_t<<" "<<t<<endl; //Se pasan las coordenadas del sistema primado del Sol, Júpiter y del planeta troyano, además del tiempo.
